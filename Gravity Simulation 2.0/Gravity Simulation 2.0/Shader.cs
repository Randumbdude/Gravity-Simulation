...
namespace Gravity_Simulation_2._0
{
    ...
    class VelocityShader : Shader
    {
        ...
        public override void Draw(Body obj, Graphics g)
        {
            ...
            g.FillEllipse(new SolidBrush(Color.FromArgb(255, r, gee, b)), (float)obj.X + Constants.xGridOffset, (float)obj.Y + Constants.yGridOffset, (float)obj.Radius * 2, (float)obj.Radius * 2);
        }
